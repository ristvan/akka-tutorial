...
//        val w4 = system.actorOf(Worker.props(4, 3), name = "worker4")
        val workers = List(
            system.actorOf(Worker.props(4, 0), name = "worker1"),
            system.actorOf(Worker.props(4, 1), name = "worker2"),
            system.actorOf(Worker.props(4, 2), name = "worker3"),
            system.actorOf(Worker.props(4, 3), name = "worker4"),
        )
...
//        val paths = List(w1.path.toString, w2.path.toString, w3.path.toString, w4.path.toString)
        val scgRouter = system.actorOf(ScatterGatherFirstCompletedGroup(paths, within = 4.second).props(), "scgRouter")
