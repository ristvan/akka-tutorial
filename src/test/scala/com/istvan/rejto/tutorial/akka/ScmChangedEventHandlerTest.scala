...
import com.istvan.rejto.tutorial.akka.ScmChangedEventHandler.{Request1, Request2, Response1, Response2}
...
class ScmChangedEventHandlerTest extends TestKit(
    ...
    "ScmChangedEvent Handler actor" should {
        val scmChangedEventHandler = system.actorOf(ScmChangedEventHandler.props(this.testActor))
